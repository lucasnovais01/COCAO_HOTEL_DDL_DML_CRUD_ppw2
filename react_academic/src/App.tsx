...
// `src/services/router/router.tsx` (via element: <Layout />).
// Evitando a importação não utilizada que causaria warning/erro de lint.
...
/*
  ...
  - Mantive as alterações anteriores (useRoutes) comentadas em histórico
    para referência, mas aqui preferi voltar ao modelo original.
*/
